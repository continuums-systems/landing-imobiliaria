...
import type { Benefit } from '../utils/types'
...
export default function FeatureCard({ benefit, index }: FeatureCardProps) {
  return (
    ...
    >
      ...
      <h3 className="mb-2 font-display text-xl font-semibold text-gray-900">{benefit.title}</h3>
